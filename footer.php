     ...
     <?php 	$social_title = get_theme_mod('social_title');
        ...
        <div class="copyright-wrapper">
        	<div class="container">            
               ...
               <?php echo esc_html('&copy; '.date('Y'));?> <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','interior-lite');?> <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/interior-wordpress-themes/');?>" target="_blank">
        <?php esc_html_e('SKT Interior Themes','interior-lite'); ?>
        </a>
            </div>          
        </div>
    </div>
